<x-app-layout>
    <div class="mx-auto mt-24 max-w-7xl px-6 sm:mt-32 md:mt-56 lg:px-8">
        <div class="mx-auto max-w-2xl lg:max-w-none">
            <div class="max-w-3xl">
                <h1 class="font-display text-5xl font-medium tracking-tight [text-wrap:balance] text-purple-600 sm:text-7xl">Hi, I''m Jyrki De Neve</h1>
                <p class="mt-6 text-xl text-neutral-600">A Belgian Laravel developer based in Latvia.</p>
            </div>
        </div>
    </div>
    <div class="mt-24 rounded-4xl bg-purple-600 py-20 sm:mt-32 sm:py-32 lg:mt-56">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:max-w-none">
                <div class="flex items-center gap-x-8">
                    <h2 class="font-display text-center text-xl font-semibold tracking-wider text-white sm:text-left">Some of my open-source packages</h2>
                    <div class="h-px flex-auto bg-purple-400"></div>
                </div>
                <div>
    ...
    <div class="mx-auto mt-24 max-w-7xl px-6 sm:mt-32 lg:mt-40 lg:px-8">
        <div class="mx-auto max-w-2xl lg:max-w-none">
            <div class="max-w-2xl">
                <h2><span class="font-display block text-4xl font-medium tracking-tight [text-wrap:balance] text-purple-600 sm:text-5xl">Blog posts</span></h2>
            </div>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div class="flex">
                    <article class="relative flex w-full flex-col rounded-3xl p-6 ring-1 ring-purple-600/5 transition hover:bg-neutral-50 sm:p-8">
                        ...
                        <p class="mt-6 flex gap-x-2 text-sm text-purple-600"><time datetime="2023" class="font-semibold">2023</time><span class="text-neutral-300" aria-hidden="true">/</span><span>Case study</span></p>
                        <p class="font-display mt-6 text-2xl font-semibold text-purple-600">Skip the bank, borrow from those you trust</p>
                ...
                <div class="flex">
                    <article class="relative flex w-full flex-col rounded-3xl p-6 ring-1 ring-purple-600/5 transition hover:bg-neutral-50 sm:p-8">
                        ...
                        <p class="mt-6 flex gap-x-2 text-sm text-purple-600"><time datetime="2022" class="font-semibold">2022</time><span class="text-neutral-300" aria-hidden="true">/</span><span>Case study</span></p>
                        <p class="font-display mt-6 text-2xl font-semibold text-purple-600">Get a hodl of your health</p>
                ...
                <div class="flex">
                    <article class="relative flex w-full flex-col rounded-3xl p-6 ring-1 ring-purple-600/5 transition hover:bg-neutral-50 sm:p-8">
                        ...
                        <p class="mt-6 flex gap-x-2 text-sm text-purple-600"><time datetime="2022" class="font-semibold">2022</time><span class="text-neutral-300" aria-hidden="true">/</span><span>Case study</span></p>
                        <p class="font-display mt-6 text-2xl font-semibold text-purple-600">Overcome your fears, find your match</p>
            ...
            <div class="lg:flex lg:items-center lg:justify-end">
                <div class="flex justify-center lg:w-1/2 lg:justify-end lg:pr-12">
                    <div class="w-[33.75rem] flex-none lg:w-[45rem]">
                        <div class="relative flex aspect-719/680 w-full justify-center grayscale lg:justify-end">
                ...
                <div>
                    <ul role="list" class="mt-16 text-base text-neutral-600 lg:mt-0 lg:w-1/2 lg:min-w-[33rem] lg:pl-4">
                        <li class="group mt-10 first:mt-0">
                            <div>
                                <div class="relative pt-10 group-first:pt-0 before:absolute before:top-0 before:left-0 before:h-px before:w-6 before:bg-purple-600 group-first:before:hidden after:absolute after:top-0 after:right-0 after:left-8 after:h-px after:bg-purple-600/10 group-first:after:hidden"><strong class="font-semibold text-purple-600">Web development. </strong>We specialise in crafting beautiful, high quality marketing pages. The rest of the website will be a shell that uses lorem ipsum everywhere.</div>
                            </div>
                        </li>
                        <li class="group mt-10 first:mt-0">
                            <div>
                                <div class="relative pt-10 group-first:pt-0 before:absolute before:top-0 before:left-0 before:h-px before:w-6 before:bg-purple-600 group-first:before:hidden after:absolute after:top-0 after:right-0 after:left-8 after:h-px after:bg-purple-600/10 group-first:after:hidden"><strong class="font-semibold text-purple-600">Application development. </strong>We have a team of skilled developers who are experts in the latest app frameworks, like Angular 1 and Google Web Toolkit.</div>
                            </div>
                        </li>
                        <li class="group mt-10 first:mt-0">
                            <div>
                                <div class="relative pt-10 group-first:pt-0 before:absolute before:top-0 before:left-0 before:h-px before:w-6 before:bg-purple-600 group-first:before:hidden after:absolute after:top-0 after:right-0 after:left-8 after:h-px after:bg-purple-600/10 group-first:after:hidden"><strong class="font-semibold text-purple-600">E-commerce. </strong>We are at the forefront of modern e-commerce development. Which mainly means adding your logo to the Shopify store template we’ve used for the past six years.</div>
                            </div>
                        </li>
                        <li class="group mt-10 first:mt-0">
                            <div>
                                <div class="relative pt-10 group-first:pt-0 before:absolute before:top-0 before:left-0 before:h-px before:w-6 before:bg-purple-600 group-first:before:hidden after:absolute after:top-0 after:right-0 after:left-8 after:h-px after:bg-purple-600/10 group-first:after:hidden"><strong class="font-semibold text-purple-600">Custom content management. </strong>At Studio we understand the importance of having a robust and customised CMS. That’s why we run all of our client projects out of a single, enormous Joomla instance.</div>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <div class="mx-auto mt-24 max-w-7xl px-6 sm:mt-32 lg:mt-40 lg:px-8">
        <div class="mx-auto max-w-2xl lg:max-w-none">
            <div class="-mx-6 rounded-4xl bg-purple-600 px-6 py-20 sm:mx-0 sm:py-32 md:px-12">
                <div class="mx-auto max-w-4xl">
                    <div class="max-w-xl">
                        <h2 class="font-display text-3xl font-medium [text-wrap:balance] text-white sm:text-4xl">Tell us about your project</h2>
                        <div class="mt-6 flex">
                            <a class="inline-flex rounded-full bg-white px-4 py-1.5 text-sm font-semibold text-purple-600 transition hover:bg-neutral-200" href="/contact"><span class="relative top-px">Say Hej</span></a>
                        </div>
                        <div class="mt-10 border-t border-white/10 pt-10">
                            ...
                            <ul role="list" class="mt-6 grid grid-cols-1 gap-8 sm:grid-cols-2">
                                <li>
                                    <address class="text-sm text-neutral-300 not-italic"><strong class="text-white">Copenhagen</strong><br />1 Carlsberg Gate<br />1260, København, Denmark</address>
                                </li>
                                <li>
                                    <address class="text-sm text-neutral-300 not-italic"><strong class="text-white">Billund</strong><br />24 Lego Allé<br />7190, Billund, Denmark</address>
                                </li>
                            </ul>
                        </div>
                    </div>
