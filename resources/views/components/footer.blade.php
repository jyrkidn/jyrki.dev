<footer class="mx-auto mt-24 w-full max-w-7xl px-6 sm:mt-32 lg:mt-40 lg:px-8">
    <div class="mx-auto max-w-2xl lg:max-w-none">
        <div>
            <div class="grid grid-cols-1 gap-x-8 gap-y-16 lg:grid-cols-2">
                <nav>
                    <ul role="list" class="grid grid-cols-2 gap-8 sm:grid-cols-3">
                        <li>
                            <div class="font-display text-sm font-semibold tracking-wider text-purple-600">Work</div>
                            <ul role="list" class="mt-4 text-sm text-purple-300">
                                <li class="mt-4"><a class="transition hover:text-purple-600" href="/work/family-fund">FamilyFund</a></li>
                                <li class="mt-4"><a class="transition hover:text-purple-600" href="/work/unseal">Unseal</a></li>
                                <li class="mt-4"><a class="transition hover:text-purple-600" href="/work/phobia">Phobia</a></li>
                                <li class="mt-4">
                                    <a class="transition hover:text-purple-600" href="/work">See all <span aria-hidden="true">→</span></a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <div class="font-display text-sm font-semibold tracking-wider text-purple-600">Company</div>
                            <ul role="list" class="mt-4 text-sm text-purple-300">
                                <li class="mt-4"><a class="transition hover:text-purple-600" href="/about">About</a></li>
                                <li class="mt-4"><a class="transition hover:text-purple-600" href="/process">Process</a></li>
                                <li class="mt-4"><a class="transition hover:text-purple-600" href="/blog">Blog</a></li>
                                <li class="mt-4"><a class="transition hover:text-purple-600" href="/contact">Contact us</a></li>
                            </ul>
                        </li>
                        <li>
                            <div class="font-display text-sm font-semibold tracking-wider text-purple-600">Connect</div>
                            <ul role="list" class="mt-4 text-sm text-purple-300">
                                <li class="mt-4"><a class="transition hover:text-purple-600" href="https://facebook.com">Facebook</a></li>
                                <li class="mt-4"><a class="transition hover:text-purple-600" href="https://instagram.com">Instagram</a></li>
                                <li class="mt-4"><a class="transition hover:text-purple-600" href="https://github.com">GitHub</a></li>
                                <li class="mt-4"><a class="transition hover:text-purple-600" href="https://dribbble.com">Dribbble</a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
            ...
            <div class="mt-24 mb-20 flex flex-wrap items-end justify-between gap-x-6 gap-y-4 border-t border-purple-600/10 pt-12">
